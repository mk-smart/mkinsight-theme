...
<!--    <link href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css" rel="stylesheet">-->
    <link href="<?php echo get_template_directory_uri(); ?>/assets/css/bootstrap-toggle.min.css" rel="stylesheet">
<!--    <script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script>-->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/bootstrap-toggle.min.js"></script>
    <!-- MDA -->
...
<!--    <script src="//cdnjs.cloudflare.com/ajax/libs/jszip/2.5.0/jszip.min.js"></script>-->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jszip.min.js"></script>
...
<!--    <script src="//cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.2/jspdf.debug.js"></script>-->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/jspdf.js"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="mki-icon"><a class="navbar-brand" href="<?php print home_url(); ?>"
